...
var f = function(){
    ...
    _proListCache._$clearListInCache = (function(){
        ...
        return function(_key){
            _u._$reverseEach(this._$getListInCache(_key),_doClear);
               return this;
        };
    })();
    /**
     ...
     * @return {nej.ut._$$ListCache}
     */
    _proListCache._$addItem = function(){
        return this;
    };
    /**
     * 添加列表项回调
     ...
     * @return {Void}
     */
    _proListCache._$deleteItem = function(){
     ...
     * @return {nej.ut._$$ListCache}
     */
    _proListCache._$updateItem = function(){
        return this;
    };
    /**
     * 更新列表项回调
