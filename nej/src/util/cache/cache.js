...
var f = function(){
     ...
     * [hr]
     * 
     * @event  {oncachechange} 缓存发生变化时触发事件
     * 
     */
    _p._$$Cache = NEJ.C();
      _proCache = _p._$$Cache._$extend(_p._$$Event);
      _supCache = _p._$$Cache._$supro;
    /**
     * 初始化函数
     * @protected
     * @method {__init}
    ...
    _proCache.__init = function(){
        ...
        if (!this.__cache){
            this.__cache = {};
            // oncachechange event list
            this.__cache[_ckey+'-v'] = [];
     ...
     *   };
     *   // 自定义cache的事件
     *   _cache._$setEvent('clickxxx',_f);
     *   // 触发事件，_i的值变为100
     *   _cache._$dispatchEvent('clickxxx');
     * [/code]
     * @see    {#._$dispatchEvent}
     * @method {_$setEvent}
     * @param  {String}   事件类型
     ...
     */
    _proCache._$setEvent = function(_type,_event){
        _type = (_type||'').toLowerCase();
        if (_type=='oncachechange'){
            this.__cache[_ckey+'-v']
                .unshift(_event||_f);
            return this;
        }
        _supCache._$setEvent.apply(this,arguments);
        return this;
    };
    /**
     * 调用事件<br/>
     ...
     * @param  {Variable} 事件可接受参数
     * @return {nej.ut._$$Cache}
     */
    _proCache._$dispatchEvent = function(_type){
        if ((_type||'').toLowerCase()=='oncachechange'){
            var _args = _r.slice.call(arguments,1);
            _u._$forEach(this.__cache[_ckey+'-v'],
                function(_callback){
                    try{_callback.apply(null,_args);}catch(ex){}
                });
            return;
        }
        return _supCache._$dispatchEvent.apply(this,arguments);
    };
    /**
     * 从缓存中取数据
     * @protected
    ...
    _proCache.__setDataInCache = function(_key,_value){
        ...
        this._$dispatchEvent('oncachechange',_key,_value);
    };
    /**
     * 删除缓存数据，不传键值则清除所有缓存
     * @protected
