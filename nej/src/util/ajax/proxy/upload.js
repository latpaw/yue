...
var f = function(){
    ...
    _proUploadProxy.__doSendRequest = (function(){
        ...
        var _doProgress = function(_url,_mode,_nocookie){
            _j._$request(_url,{
                type:'json',
                method:'POST',
                nocookie:_nocookie,
                ...
                onload:function(_data){
                    ...
                    this.__timer = window.setTimeout(
                          _doProgress._$bind(this,_url,_mode,_nocookie),1000);
                }._$bind(this),
            ...
            this.__frame = _e._$createXFrame({
                ...
                onload:function(_event){
                    ...
                    var _mode = (_form.nej_mode||_o).value,
                        _nocookie = (_form.nej_nocookie||_o).value;
                    this.__timer = window.setTimeout(
                          _doProgress._$bind(this,_qurl,_mode,_nocookie),100);
                }._$bind(this)
            });
        };
    })();
