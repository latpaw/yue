...
var f = function(){
     ...
     * 
     *   // 分配一个名称为“/”的节点
     *   var _root = nej.ut._$$Node._$allocate();
     *   
     *   // 分配一个名称为“a”的节点，并指定父节点为_root
     *   var _aNode = nej.ut._$$Node._$allocate({
     *       parent:_root,
     *       name:'a'
     *   });
     *   
     *   // 分配一个名称为“b”的节点，手动设置父节点
     *   var _bNode = nej.ut._$$Node._$allocate({
     *       name:'b'
     *   });
