...
var f = function(){
    ...
    _e._$wrapInline = (function(){
        ...
        var _doInitStyle = function(){
            if (!!_clazz) return;
            _clazz = _e._$pushCSSText('\
                .#<uispace>{position:relative;zoom:1;}\
                .#<uispace>-show{position:absolute;top:0;left:100%;cursor:text;white-space:nowrap;overflow:hidden;}\
            ');
            _e._$dumpCSSText();
        };
        return function(_element,_options){
    ...
    _e._$addScript = function(_script){
        ...
        if (!_script) return;
        try{return (new Function(_script))();}catch(ex){}
    };
    /**
     * 缓存待激活样式<br/>
     * 
     ...
     * @return {nej.e}
     */
    _e._$addClassName = function(_element,_add){
     ...
     * @return {nej.e}
     */
    _e._$delClassName = function(_element,_del){
     ...
     * @return {nej.e}
     */
    _e._$replaceClassName = function(_element,_del,_add){
     ...
     */
    _e._$hasClassName = function(_element,_class){
