                ...
                <div class="sect">
					...
					<input type="hidden" name="id" value="100027" />
						...
						<div style="margin:20px; line-height:20px;">
							<h4>确保下列目录或文件可写</h4>
							<ul>
							<li>目录：include/configure/ ---------------- <b><?php echo !$writeable['c'] ? '<font color="red">不可写</font>':'<font color="green">可写</font>'; ?></b></li>
							<li>目录：include/data/ ---------------- <b><?php echo !$writeable['d'] ? '<font color="red">不可写</font>':'<font color="green">可写</font>'; ?></b></li>
							<li>目录：static/team/ ---------------- <b><?php echo !$writeable['t'] ? '<font color="red">不可写</font>':'<font color="green">可写</font>'; ?></b></li>
							<li>目录：static/user/ ---------------- <b><?php echo !$writeable['u'] ? '<font color="red">不可写</font>':'<font color="green">可写</font>'; ?></b></li>
							</ul>
						</div>
                        <div class="act">
